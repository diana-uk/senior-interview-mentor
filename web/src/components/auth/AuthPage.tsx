...
export default function AuthPage({ onSignIn, onSignUp, onOAuth, onSkip }: AuthPageProps) {
    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-brand">
          ...
          <h1 className="auth-title">Senior Interview Mentor</h1>
          <p className="auth-subtitle">AI-powered coding interview coaching</p>
        </div>
