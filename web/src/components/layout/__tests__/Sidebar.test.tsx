...
vi.mock('lucide-react', () => ({
  ...
  CalendarDays: (props: Record<string, unknown>) => <div data-testid="icon-calendar" {...props} />,
...
vi.mock('../../panels/StudyPlanPanel', () => ({
  default: () => <div data-testid="study-panel">StudyPlanPanel</div>,
}));
...
describe('Sidebar', () => {
  ...
  describe('navigation icons', () => {
    it('renders all 10 nav icons plus settings', () => {
      renderSidebar();
      ...
      expect(screen.getByLabelText('Study Plan')).toBeDefined();
  ...
  describe('panel content', () => {
    ...
    it('renders StudyPlanPanel when study panel is active', () => {
      renderSidebar({ activePanel: 'study' });
  ...
  describe('panel header', () => {
    ...
    it('shows "Study Plan" title for study panel', () => {
      renderSidebar({ activePanel: 'study' });
      expect(screen.getByText('Study Plan')).toBeDefined();
    });
